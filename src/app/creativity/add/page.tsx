    ...
    return (
        <Navbar>
            ...
            <form action={handleSubmit} className='flex flex-col gap-y-4 max-w-[50%] m-4 font-bold'>
                ...
                <div className='flex flex-col'>
                    <label>Author</label>
                    <input type='text' placeholder='Name' className='p-2 border border-primary' name='author' />
                </div>
                <div className='flex flex-col'>
                    <label>Rating (0 to 5)</label>
                    <input type='text' placeholder='Name' className='p-2 border border-primary' name='rating' />
                </div>
                <div className='flex flex-col'>
                    <label>Review Count (Eg. 2000)</label>
                    <input type='text' placeholder='Name' className='p-2 border border-primary' name='review' />
                </div>
                <div className='flex flex-col'>
                    <label>Price</label>
                    <input type='text' placeholder='Name' className='p-2 border border-primary' name='price' />
                </div>
                <div className='flex flex-col'>
                    <label>Description</label>
                    <input type='text' placeholder='Name' className='p-2 border border-primary' name='description' />
                </div>
                <div className='flex flex-col'>
                    <label>URL</label>
                    <input type='text' placeholder='Name' className='p-2 border border-primary' name='url' />
                </div>
